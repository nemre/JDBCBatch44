Feature: US1002 kullanıcı DBUtil ile database baglanıp istediği field bilgilerini okur

  @dbu
  Scenario: TC02 kullanıcı tablo ve field ismi ile sorgu yapabilmeli
